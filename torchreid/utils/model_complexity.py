...
from torchreid.models import SamReID
from torchreid.models.kpr import KPR
...
def compute_model_complexity(
    ...
    if isinstance(model, KPR):
        model(input_img, torch.ones(1, cfg.model.kpr.masks.parts_num+1, 16, 8))  # forward
    else:
